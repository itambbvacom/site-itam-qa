...
function init() {
  gapi.auth.authorize(
     {client_id: clientId, scope: scopes, immediate: true, response_type : token id_token},
      handleAuthResult);
}
...
function handleAuthClick(event) {
  gapi.auth.authorize(
      {client_id: clientId, scope: scopes, immediate: false, response_type : token id_token},
      handleAuthResult);
  return false;
}
