...
function draw() {
	...
	/* LAB
	https://drive.google.com/open?id=1ZOw0_Z-BfC9xKp2Fxk4c33xnwLMxVYco1e6cKo0X5wA
	*/
	...
	*/
	...
	/* PROD
	https://drive.google.com/open?id=1H-GWfPxz-oTpkYJ2YGEhRl91QyI7wwclfD4VQnIG4vM
...
function slide_news() {
	$('#slides').slides({
			preload : true,
			preloadImage : 'https://rawgit.com/itambbvacom/site-itam-qa/master/img/loading.gif',
			play : 7000, //7000
			pause : 3500,//3500
			hoverPause : true,
